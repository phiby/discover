...
public class HotelsFragment extends Fragment {
    ...
    private ArrayList<Album> getOnSaleAlbum() {
        ...
        Album album = new Album("STANLEY SAFARI LODGE  : Victoria Falls", R.drawable.stanley);
        albums.add(album);

        album = new Album("TROUTBACK HOTEL  : Nyanga", R.drawable.chinhoyicaves);
        albums.add(album);

        album = new Album("CARIBBEA BAY HOTEL  : Kariba", R.drawable.caribbea);
        albums.add(album);

        album = new Album("GREAT ZIMBABWE HOTEL  :  Great Zimbabwe", R.drawable.greatzz);
        albums.add(album);

        album = new Album("HWANGE SAFARI LODGE  :  Hwange", R.drawable.hwangas);
        albums.add(album);


        album = new Album("TROUTBECK HOTEL  : Inyanga", R.drawable.trout);
        albums.add(album);
